...
Public Class frmQuenMK
    ...
    Private Sub frmQuenMK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        conn = New SqlConnection("Data Source=LAPTOP-8G5K1URS\DAMHAILONG;Initial Catalog=QuanLyBanHang;Integrated Security=True")
        conn.Open()
    End Sub
    Private Sub btnCapNhat_Click(sender As Object, e As EventArgs) Handles btnCapNhat.Click
        ...
        Dim connectionString As String = "Data Source=LAPTOP-8G5K1URS\DAMHAILONG;Initial Catalog=QuanLyBanHang;Integrated Security=True;User ID=TaiKhoan;Password=MatKhau;"
